...
// If ToggleTheme is not provided from App, fallback to a default context
const DefaultThemeContext = React.createContext(false);
...
function UseContext() {
  ...
  const theme = useContext(ToggleTheme || DefaultThemeContext);
